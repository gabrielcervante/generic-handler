...
func FindFuncType[I, O any](ctx context.Context, input I, fnToFindType any) (O, error) {
	...
	if reflect.TypeOf(fnToFindType).NumIn() == 2 && reflect.TypeOf(fnToFindType).NumOut() == 1 {
		return emptyOutput[I, O](ctx, input, fnToFindType.(types.ErrorFunction[I]))
	}
...
func emptyOutput[I, O any](ctx context.Context, i I, fn types.ErrorFunction[I]) (_ O, err error) {
	err = fn(ctx, i)
	return
}
